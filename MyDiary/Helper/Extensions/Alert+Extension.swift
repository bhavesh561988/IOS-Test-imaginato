...
extension UIAlertController{
    ...
    class func showAlertWithOkButton(_ controller : AnyObject ,
        ...
        self.showAlert(controller, aStrMessage: aStrMessage, aStrTitle: aStrTitle, style: .alert, aCancelBtn: nil, aDistrutiveBtn: nil, otherButtonArr: ["OK"], completion: completion)
